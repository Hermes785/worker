...
RUN pip install --no-cache-dir pymupdf python-docx numpy minio opencv-python-headless  kafka fontTools && pip install mysql-connector-python --no-cache-dir -r requirements.txt
